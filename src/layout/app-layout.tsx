...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['owner', 'manager', 'inventory-clerk', 'shipping-coordinator', 'customer'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Shipments', path: '/shipments', entity: 'shipment', service: AccessServiceEnum.PROJECT, icon: FiTruck },
    { name: 'Warehouses', path: '/warehouses', entity: 'warehouse', service: AccessServiceEnum.PROJECT, icon: FiHome },
