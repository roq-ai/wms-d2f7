...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'OrderCreated.create': {
    roles: ['owner', 'manager', 'inventory-clerk', 'shipping-coordinator'],
    key: 'order_id',
    tenantPath: [],
    userPath: [],
  },
  'InventoryUpdated.update': { roles: ['owner', 'manager'], key: 'inventory_id', tenantPath: [], userPath: [] },
  'ShippingUpdated.update': {
...
const tenantRoles: string[] = ['owner', 'manager', 'inventory-clerk', 'shipping-coordinator', 'customer'];
