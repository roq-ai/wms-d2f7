            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('warehouse', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/warehouses/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem label="Manager Id" text={data?.manager_id} />

                <FormListItem label="Warehouse Type" text={data?.warehouse_type} />

                <FormListItem label="Operational Hours" text={data?.operational_hours} />
              </List>
            </FormWrapper>
          </>
        )}
