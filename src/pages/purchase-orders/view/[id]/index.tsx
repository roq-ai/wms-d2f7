...
import { getPurchaseOrderById } from 'apiSdk/purchase-orders';
import { PurchaseOrderInterface } from 'interfaces/purchase-order';

function PurchaseOrderViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('purchase_order', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/purchase-orders/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem label="Delivery Notes" text={data?.delivery_notes} />
              </List>
            </FormWrapper>
          </>
        )}
