  ...
  const columns: ColumnType[] = [
    {
      ...
      cell: ({ row: { original: record } }: any) =>
        record?.last_checked ? format(parseISO(record?.last_checked as unknown as string), 'dd-MM-yyyy') : '',
    },
    {
      id: 'last_updated',
      header: 'Last Updated',
    ...
    { id: 'quantity_on_hand', header: 'quantity_on_hand', accessorKey: 'quantity_on_hand' },
    {
      id: 'expiration_date',
      header: 'Expiration Date',
      accessorKey: 'expiration_date',
      cell: ({ row: { original: record } }: any) =>
        record?.expiration_date ? format(parseISO(record?.expiration_date as unknown as string), 'dd-MM-yyyy') : '',
    },
    { id: 'product_id', header: 'product_id', accessorKey: 'product_id' },
    { id: 'location_id', header: 'location_id', accessorKey: 'location_id' },
    { id: 'reorder_threshold', header: 'reorder_threshold', accessorKey: 'reorder_threshold' },
    !hideActions
      ? {
          id: 'actions',
          header: '',
