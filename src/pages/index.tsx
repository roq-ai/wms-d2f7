  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to WMS - Streamlining your warehouse operations with our comprehensive management solution, enabling efficiency and accuracy in every step."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1553413077-190dd305871c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx3YXJlaG91c2V8ZW58MHx8fHwxNjk1ODg3MjEzfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@ruchindra?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Ruchindra Gunasekara`}</Link>{' '}
              on{' '}
              <Link
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to WMS - Streamlining your warehouse operations with our comprehensive management solution, enabling efficiency and accuracy in every step.`}
            </Text>
            <Box
