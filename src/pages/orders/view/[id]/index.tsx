                ...
                <FormListItem
                  ...
                  text={
                    data?.estimated_delivery_date
                      ? format(parseISO(data?.estimated_delivery_date as unknown as string), 'dd-MM-yyyy')
                      : ''
                  }
                />

                <FormListItem label="Order Tracking Number" text={data?.order_tracking_number} />

                <FormListItem label="Order Priority" text={data?.order_priority} />
              </List>
            </FormWrapper>
          </>
        )}
