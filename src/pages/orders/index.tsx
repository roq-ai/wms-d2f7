...
export function OrderListPage(props: OrderListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getOrders({
        ...
        order: params.order,
        searchTermKeys: ['order_status.contains', 'order_tracking_number.contains', 'order_priority.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'order_tracking_number', header: 'Order Tracking Number', accessorKey: 'order_tracking_number' },
    { id: 'order_priority', header: 'Order Priority', accessorKey: 'order_priority' },
    !hideActions
      ? {
          id: 'actions',
          header: '',
